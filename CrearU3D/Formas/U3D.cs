...
public class U3D : Objeto
{
    ...
    public U3D(Punto posicion, Color4 color) : base([], posicion)
    {
        ...
        AgregarParte("Izquierdo", Utils.CrearBloque3D(bloqueIzquierdo, color));

        List<Punto> bloqueDerecho = [
        ...
        AgregarParte("Derecho", Utils.CrearBloque3D(bloqueDerecho, color));
