...
public class Camara
{
    ...
    public void Mover(float deltaX, float deltaY, float deltaZ)
    {
        // Lógica para mover la cámara (si necesitas movimiento libre)
        // ...
    }
    ...
    public void ProcesarInput(KeyboardState keyboard)
    {
        ...
        if (keyboard[Key.W]) AcercarAlejar(-0.1f);
        if (keyboard[Key.S]) AcercarAlejar(0.1f);
    }
